...
# УСТАНОВИТЬ в ИНДЕКС столбец 'date' можно с помощью команды:
dau_new = dau.set_index('date')
...
#    будут переданы все ЗНАЧЕНИЯ ТЕКУЩЕГО РЯДА.

# (axis = 0 - будет указывать на все значения в столбце)
